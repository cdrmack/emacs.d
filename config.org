...
=hydra= is a package that can be used to tie related commands into a family of short bindings.
I'm not yet sure if I need this.
...
=general= provides convenient wrappers for more succinctly defining keybindings.

Use =C-SPC= to display custom bindings.
Use =cdrmack/leader-keys= to define keybindings.

#+begin_src emacs-lisp
  (use-package general
    :config
    (general-create-definer cdrmack/leader-keys
    ...
    (cdrmack/leader-keys
      ...
      "ba" '(save-some-buffers :which-key "save all")
      ...
      "pa" '(projectile-ag :which-key "ag")
      "pk" '(projectile-kill-buffers :which-key "kill buffers")
      "ps" '(projectile-save-project-buffers :which-key "save buffers")

      "s" '(hydra-zoom/body :which-key "zoom")

      "g" '(:ignore t :which-key "git")
      "gs" '(magit-status :which-key "status")
      "gl" '(magit-log-current :which-key "log")

      "q" '(save-buffers-kill-terminal :which-key "kill terminal")
      "k" '(save-buffers-kill-emacs :which-key "kill emacs")))
#+end_src
